...
[index, scores] = fscmrmr(plant_species_class_data(:, 1:end-1), plant_species_class_data(:, end));

plant_species_class_data = [plant_species_class_data(:, index(1:20)), plant_species_class_data(:, end)];
