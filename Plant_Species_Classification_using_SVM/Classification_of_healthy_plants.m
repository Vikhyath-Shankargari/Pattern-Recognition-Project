...
healthy_plant_species_data = training_data(training_data(:,end)==2, 1:end-1);

rin = randperm(length(healthy_plant_species_data));
healthy_plant_species_data = healthy_plant_species_data(rin, :);
